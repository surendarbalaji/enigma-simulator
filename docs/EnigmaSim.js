...
// include: C:\Users\Sbala\AppData\Local\Temp\tmp6le49j1d.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'EnigmaSim.data';
      var REMOTE_PACKAGE_BASE = 'EnigmaSim.data';
...
Module['FS_createPath']("/", "resources", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_EnigmaSim.data');
      }
      Module['addRunDependency']('datafile_EnigmaSim.data');
    ...
    loadPackage({"files": [{"filename": "/resources/mechanical.ttf", "start": 0, "end": 124460}], "remote_package_size": 124460});

  })();

// end include: C:\Users\Sbala\AppData\Local\Temp\tmp6le49j1d.js
// include: C:\Users\Sbala\AppData\Local\Temp\tmpud44e5g4.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\Sbala\AppData\Local\Temp\tmpud44e5g4.js
// include: C:\Users\Sbala\AppData\Local\Temp\tmps6uevv7h.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\Sbala\AppData\Local\Temp\tmps6uevv7h.js
...
function findWasmBinary() {
  return locateFile('EnigmaSim.wasm');
}
...
var ASM_CONSTS = {
 ...
 98788: () => { return Module.canvas.width; },  
 98820: () => { return parseInt(Module.canvas.style.width); },  
 98868: () => { document.exitFullscreen(); },  
 98895: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 98967: () => { if (document.fullscreenElement) return 1; },  
 99013: () => { return Module.canvas.width; },  
 99045: () => { return screen.width; },  
 99070: () => { document.exitFullscreen(); },  
 99097: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 99291: () => { return window.innerWidth; },  
 99317: () => { return window.innerHeight; },  
 99344: () => { if (document.fullscreenElement) return 1; },  
 99390: () => { return Module.canvas.width; },  
 99422: () => { return parseInt(Module.canvas.style.width); },  
 99470: () => { if (document.fullscreenElement) return 1; },  
 99516: () => { return Module.canvas.width; },  
 ...
 99672: () => { return Module.canvas.width; },  
 99704: () => { return screen.width; },  
 99729: () => { document.exitFullscreen(); },  
 99756: () => { if (document.fullscreenElement) return 1; },  
 99802: () => { return Module.canvas.width; },  
 99834: () => { return parseInt(Module.canvas.style.width); },  
 99882: () => { document.exitFullscreen(); },  
 99909: ($0) => { Module.canvas.style.opacity = $0; },  
 99947: () => { return screen.width; },  
 99972: () => { return screen.height; },  
 99998: () => { return window.screenX; },  
 100025: () => { return window.screenY; },  
 100052: () => { return window.devicePixelRatio; },  
 100088: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 100141: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 100192: () => { Module.canvas.style.cursor = 'none'; },  
 100229: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 100485: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 100536: () => { if (document.pointerLockElement) return 1; },  
 100583: () => { if (document.fullscreenElement) return 1; },  
